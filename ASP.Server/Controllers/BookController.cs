...
namespace ASP.Server.Controllers
{
    ...
    public class BookController : Controller
    {
        ...
        public ActionResult<IEnumerable<Book>> List()
        {
            ...
            var ListBooks = libraryDbContext.Books.Include(book => book.Genre).OrderBy(book => book.Id).ToList();
        ...
        {
            var bookToModify = libraryDbContext.Books.Include(book => book.Genre).Single(book => book.Id == idToModify);            // Le IsValid est True uniquement si tous les champs de CreateBookModel marqués Required sont remplis
